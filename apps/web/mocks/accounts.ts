/**
 * The three synthetic applicants the mock world starts with.
 *
...
export const READY_APPLICANT_EMAIL = 'applicant.ready@example.test';
...
export const READY_APPLICANT_ID = '77777777-7777-4777-8777-777777777773';
